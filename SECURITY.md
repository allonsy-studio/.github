...
We take the security of Allons-y Studio projects seriously. Thank you for
helping keep our software and our users safe.

## Supported versions

Unless a repository documents otherwise, we provide security fixes for the
**latest released major version** of each project. Older versions are supported
...
public disclosure. We're committed to coordinating with you throughout the
process.
